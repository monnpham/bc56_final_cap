        ...
        >
            ...
            <div className="flex mt-2">
                <div className="" style={{ width: "50%" }}>
                    ...
                    <p>Not yet added</p>
                    <div className="mr-2" style={{ overflow: "hidden scroll", height: "400px" }}>
                        {isLoading ? (
                                        ...
                                        <div className="flex justify-between items-center">
                                            <div className="flex items-center">
                                                ...
                                                <div className="grid ml-2">
                                                    {member.name.length > 10 ? `${member.name.substring(0, 4)}...` : member.name}
                ...
                <div className="mt-10" style={{ width: "50%" }}>
                    Already in project
                    <div className="ml-2" style={{ overflow: "hidden scroll", height: "400px" }}>
